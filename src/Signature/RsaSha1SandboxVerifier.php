...
/**
 * Verifies legacy RSA SHA-1 postbacks emitted by the NovaPay sandbox.
 */
final class RsaSha1SandboxVerifier implements SandboxLegacyVerifierInterface {

  private const MAX_SIGNATURE_BASE64_BYTES = 16384;

  /**
   * Constructs the legacy NovaPay sandbox verifier.
   */
